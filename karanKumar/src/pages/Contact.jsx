...
export const Contact = () => {
  ...
  if (state.succeeded) {
    return (
      <>
        <SEO
          title="Contact Karan Kumar | Hire Full Stack Developer"
          description="Contact Karan Kumar for freelance, contract, and full-time software development opportunities in React, Node.js, and full stack web development."
          keywords="hire full stack developer, contact React developer, Node.js freelancer, web developer contact"
          canonical="https://imksh.online/contact"
        ...
        <div className="section-container mt-10 w-[95%] md:w-[60%] mx-auto glass-surface rounded-2xl p-8 flex flex-col justify-center items-center gap-4 text-center">
          <h3 className="text-xl md:text-3xl font-bold text-clip1">
            Contact Me
          </h3>

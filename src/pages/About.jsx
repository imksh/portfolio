...
import { FaArrowRight,FaGithub,FaLinkedin,FaInstagramSquare,FaFileDownload,FaCode } from "react-icons/fa";
        ...
        <div className={styles.container}>
            <div className={styles.about} data-aos="fade-up-right">
                ...
                <div className={styles.btnDiv}>
                    <a href="https://api.whatsapp.com/send?phone=7295038835&text=Hi%20Karan%2C%20I%20visited%20your%20portfolio%20and%20wanted%20to%20connect."><button>Let's Book A Call‎ ‎ ‎  <FaArrowRight /></button></a>
                    
                </div>
                <div className={styles.icons}>
                    <div className={styles.icon}>
                        <a href="https://github.com/imksh"><FaGithub /></a>
                    </div>
                    <div className={styles.icon}>
                        <a href="https://www.linkedin.com/in/imksh3"><FaLinkedin /></a>
                    </div>
                    <div className={styles.icon}>
                        <a href="https://www.linkedin.com/in/imksh3/"><FaInstagramSquare /></a>
                    </div>
                </div>
            </div>
